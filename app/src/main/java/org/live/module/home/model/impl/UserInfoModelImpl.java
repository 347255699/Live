...
public class UserInfoModelImpl implements UserInfoModel {
    ...
    public void editUserInfo(String key, String val) {
        ...
        params.put(key, val);
        try {
            HttpRequestUtils.requestHttp(LiveConstants.REMOTE_SERVER_HTTP_IP + "/app/user/" + HomeActivity.mobileUserVo.getUserId(),
                    "PUT", params, editUserInfoResponseHandler, HomeConstants.HTTP_RESPONSE_RESULT_EDDIT_USER_INFO_CODE); // 发送修改请求
        } catch (Exception e) {
