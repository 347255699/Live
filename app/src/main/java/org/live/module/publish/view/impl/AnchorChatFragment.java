...
public class AnchorChatFragment extends Fragment {
    private static final String TAG = "Global";
    private ListView cRecordsListView; // 记录列表
    private AnchorChatFragment.ChatRecordAdapter adapter; // 聊天记录适配器
    ...
    private AnchorChatService.ChatReceiveServiceBinder anchorChatServiceBinder; // 聊天服务绑定实体
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof OnPublishActivityListener) {
            this.publishActivityListener = (OnPublishActivityListener) getActivity();
        }
    ...
    private void initUIElements() {
        ...
        cLastChatRecord.setTypeface(typeFace); // 应用字体

        adapter = new AnchorChatFragment.ChatRecordAdapter(getActivity());
