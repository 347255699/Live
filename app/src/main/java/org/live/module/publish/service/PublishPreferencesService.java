package org.live.module.publish.service;
...
public class PublishPreferencesService extends IntentService {
    private static final String TAG = "MainLog";
    private SharedPreferences publishPreferences = null;
    private Bundle bundle = null;

    public PublishPreferencesService() {
        super("PublishPreferencesService");
    }
